...
@RestControllerAdvice(assignableTypes = TestRunCommandController.class)
public class CommandApiExceptionHandler {

  @ResponseStatus(HttpStatus.CONFLICT)
  @ExceptionHandler(
      value = InvalidTestRunStateTransitionException.class,
