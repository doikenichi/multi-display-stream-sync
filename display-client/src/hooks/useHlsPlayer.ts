...
import type {PlaybackError, PlaybackMode, PlaybackStatus, VideoDiagnostics} from "../types/display";
  ...
  useEffect(() => {
    ...
    if (Hls.isSupported()) {
      ...
      return () => {
        ...
        videoElement.removeEventListener("loadedmetadata", updateVideoDiagnostics);
