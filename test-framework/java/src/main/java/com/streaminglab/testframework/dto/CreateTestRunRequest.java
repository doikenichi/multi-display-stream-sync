 ...
 * <p>
 * This class encapsulates the parameters required to initiate a test run. It is used
 * by clients to specify the stream details and the number of display clients for the test setup.
 * <p>
