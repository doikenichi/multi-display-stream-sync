...
It prepares a run-specific streaming environment by creating a test run, generating deterministic synthetic frames, starting FFmpeg, publishing to MediaMTX, exposing an HLS URL, managing packet capture, and exposing artifact locations.
